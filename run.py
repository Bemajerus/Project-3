...
def main():
    ...
    while True:
        ...
        if choice == "1": # If the user's choice is "1", prompts for information about the new task, creates an instance of Task, adds it to the task list, and informs the user that the task was added successfully.
        ...
        elif choice == "2": # If the user's choice is "2", displays the list of tasks using the list_tasks method of the TaskManager class.
            print("\nTask List:")
            task_manager.list_tasks()
        
        elif choice =="3": # If the user's choice is "3", prompts for the task index to delete, converts it to an integer, and calls the delete_task method of the TaskManager class.
            index = int(get_user_input("Enter the task index to delete: ")) -1
            task_manager.delete_task(index)
            
        elif choice == "4": # If the user's choice is "4", prompts for the task index to update and new task information, converts the index to an integer, creates an instance of Task, and calls the update_task method of the TaskManager class.
        ...
        elif choice == "5": # If the user's choice is "5", prints an exit message and breaks the loop, ending the program.
